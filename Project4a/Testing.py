...
def main():
	print('DummySet1, infoFunc is infoGain')
	tree1, evaluation1 = testDummySet1()
	print('DummySet2, infoFunc is infoGain')
	tree2, evaluation2 = testDummySet2()
	print('Connect4, infoFunc is infoGain')
	tree3, evaluation3 = testConnect4()
	print('Car, infoFunc is infoGain')
	tree4, evaluation4 = testCar()
